...
namespace WinMine
{
    public partial class Demo : Game.Game
    {
        ...
        /// </summary>
        public Elements.Imagenes Resources { get; set; }
        /// <summary>
        ...
        {
            var form = new WinMine.Configuracion(this.Config);
        ...
        private void Initialize()
        {
            ...
            this.Resources = new Elements.Imagenes()
            {
        ...
        private void Start_Game()
        {
            ...
            {
                Playing = false;
                MessageBox.Show("¡Perdiste!", "UPEM - SOFTWARE", MessageBoxButtons.OK, MessageBoxIcon.Error);
            };
            Board.Match_Won += (sender, e) =>
            {
                Playing = false;
                MessageBox.Show("¡Ganaste!", "UPEM - SOFTWARE", MessageBoxButtons.OK, MessageBoxIcon.Information);
            };
        ...
        protected override void Update()
        {
            if (Playing)
            {
                if (_startTime.HasValue)
                {
                    ...
                    txtTiempo.Text = time.Value.ToString("hh\\:mm\\:ss\\.ffff");
                }
                else
                    txtTiempo.Text = "00:00:00.0000";

                txtMinas.Text = (Config.Mines - Board.Flags).ToString();
            }
        }
        #endregion
