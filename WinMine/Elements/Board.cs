...
namespace WinMine.Elements
{
    public class Board : Sprite
    {
        ...
        #region Objects
        /// <summary>
        /// Coordenadas de la mina a descubrir por el jugador
        /// </summary>
        private List<Point> _availableLocations;
        #endregion

        #region Constructor
        public Board(Elements.Config config, Elements.Imagenes resources) : base(null, Point.Empty)
        {
            this.Config = config;
        ...
        #region Properties
        /// <summary>
        /// Cantidad de banderas en la mina
        /// </summary>
        ...
        /// Recursos graficos
        /// </summary>
        private Elements.Imagenes Resources { get; set; }
        #endregion
        ...
        /// <summary>
        /// Selecciona una celda de la mina
        /// </summary>
